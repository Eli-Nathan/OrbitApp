...
function SvgThunderstorms(props) {
    return (
        <Svg width={160} height={160} {...props}>
            <Defs>
                <Path
                    id="Thunderstorms_svg__a"
                    d="M.234.181h89.49v87.023H.234z"
                />
                <Path id="Thunderstorms_svg__c" d="M0 .18h120.149v87.024H0z" />
            </Defs>
            <G fill="none" fillRule="evenodd">
                <G transform="translate(69 4.819)">
                    <Mask id="Thunderstorms_svg__b" fill="#fff">
                        <Use xlinkHref="#Thunderstorms_svg__a" />
                    </Mask>
                    <Path
                        ...
                        fill="#325577"
                        mask="url(#Thunderstorms_svg__b)"
                    />
                </G>
                <G transform="translate(2 25.819)">
                    <Mask id="Thunderstorms_svg__d" fill="#fff">
                        <Use xlinkHref="#Thunderstorms_svg__c" />
                    </Mask>
                    <Path
